...
class _PlaneDetectionPageState extends State<PlaneDetectionPage> {
  ...
  void _addPlane(ARKitController controller, ARKitPlaneAnchor anchor) {
    ...
    xAxis = ARKitLine(
      fromVector: anchor.center,
      toVector: vector.Vector3(
          anchor.center.x + 0.5, anchor.center.y, anchor.center.z),
      materials: [
        ARKitMaterial(
          transparency: 1,
    ...
    yAxis = ARKitLine(
      fromVector: anchor.center,
      toVector: vector.Vector3(
          anchor.center.x , anchor.center.y+ 0.5, anchor.center.z),
      materials: [
        ARKitMaterial(
          transparency: 1,
    ...
    zAxis = ARKitLine(
      fromVector: anchor.center,
      toVector: vector.Vector3(
          anchor.center.x, anchor.center.y, anchor.center.z+ 0.5),
      materials: [
        ARKitMaterial(
          transparency: 1,
