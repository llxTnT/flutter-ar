...
class ARKitController {
  ...
  Future<Vector3> getNodeWorldPosition(String nodeName) async {
    assert(nodeName != null);
    final vector= await _channel.invokeMethod('getNodeWorldPosition', {'nodeName': nodeName});
    return vector != null
        ? _vector3Converter.fromJson(List<double>.from(vector))
        : null;
  }
