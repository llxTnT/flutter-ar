...
import 'package:arkit_plugin_example/magician_demo_page.dart';
...
import 'package:arkit_plugin_example/plane_axis_item_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final samples = [
      Sample(
        'Flutter Magician ARKit Demo',
        'ARKit Demo,Use Magician pick up AR Item',
        Icons.adb,
    ...
    /*  Sample(
     ...
     /* Sample(
      ...
      Sample(
        'Draw Distance Line',
        'Draw a line between source to plane',
        Icons.ac_unit,
            () => Navigator.of(context).push<void>(
